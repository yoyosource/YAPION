...
class TripleSerializer: FinalInternalSerializer<Triple<Any, Any, Any>> {

    override fun type(): Class<*> {
        return Triple::class.java
    }

    override fun serialize(serializeData: SerializeData<Triple<Any, Any, Any>>?): YAPIONAnyType {
        return YAPIONObject().add("first", serializeData!!.serialize(serializeData.`object`.first))
            ...
            .add("third", serializeData.serialize(serializeData.`object`.third))
    }

    override fun deserialize(deserializeData: DeserializeData<out YAPIONAnyType>?): Triple<Any, Any, Any> {
        ...
        return Triple(
            ...
            deserializeData.deserialize(yapionObject.get("third"))
        )
    }
}