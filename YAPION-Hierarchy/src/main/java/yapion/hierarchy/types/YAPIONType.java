...
public enum YAPIONType {
    ...
    ANY(0x21b7bcb508370b96L, "ANY", (yapionAnyType, s, yapionAnyType2) -> {
        throw new YAPIONException("ANY is no YAPIONType to call add on");
    }),
    ...
    POINTER(0x4e958af3539fb57cL, "PNR", (yapionAnyType, s, yapionAnyType2) -> {
        throw new YAPIONException("POINTER is no YAPIONType to call add on");
    }),
    VALUE(0xf86bfba6285c9be2L, "VAL", (yapionAnyType, s, yapionAnyType2) -> {
        throw new YAPIONException("VALUE is no YAPIONType to call add on");
    }),

    COMMENT(0x0, "CMT", (yapionAnyType, s, yapionAnyType2) -> {
        throw new YAPIONException("COMMENT is no YAPIONType to call add on");
    });
