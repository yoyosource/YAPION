...
public class YAPIONSerializerPacker {

    public static void main(String[] args) throws Exception {
        String s = YAPIONSerializerPacker.class.getProtectionDomain().getCodeSource().getLocation().getFile();
        s += YAPIONSerializerPacker.class.getPackage().getName().replace('.', '/');
