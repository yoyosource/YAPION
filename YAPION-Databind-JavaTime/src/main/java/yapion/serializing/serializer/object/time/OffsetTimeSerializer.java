...
public class OffsetTimeSerializer implements FinalInternalSerializer<OffsetTime> {
    ...
    public OffsetTime deserialize(DeserializeData<? extends YAPIONAnyType> deserializeData) {
        ...
        LocalTime localTime = deserializeData.deserialize(yapionObject.getObject("localTime"));
