...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println(YAPIONUtils.flatten(yapionObject).toYAPIONPrettified(new StringOutput()).getResult());
        System.out.println();
        System.out.println(YAPIONUtils.unflatten(YAPIONUtils.flatten(yapionObject)).toYAPIONPrettified(new StringOutput()).getResult());
        System.out.println();
