...
public class ConcurrentLinkedDequeSerializer implements InternalSerializer<ConcurrentLinkedDeque<?>> {
    ...
    @Override
    public YAPIONAnyType serialize(SerializeData<ConcurrentLinkedDeque<?>> serializeData) {
    ...
    @Override
    public ConcurrentLinkedDeque<?> deserialize(DeserializeData<? extends YAPIONAnyType> deserializeData) {
