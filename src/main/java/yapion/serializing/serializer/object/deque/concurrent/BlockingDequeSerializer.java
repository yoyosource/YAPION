...
public class BlockingDequeSerializer implements InternalSerializer<BlockingDeque<?>> {
    ...
    @Override
    public YAPIONAnyType serialize(SerializeData<BlockingDeque<?>> serializeData) {
    ...
    @Override
    public BlockingDeque<?> deserialize(DeserializeData<? extends YAPIONAnyType> deserializeData) {
