...
package yapion.serializing.serializer.object.regex;
...
public class PatternSerializer implements InternalSerializer<Pattern> {
    ...
    @Override
    public Pattern deserialize(DeserializeData<? extends YAPIONAnyType> deserializeData) {
        YAPIONObject yapionObject = (YAPIONObject) deserializeData.object;
        String pattern = yapionObject.getPlainValue("pattern");
        int flags = yapionObject.getPlainValue("flags");
