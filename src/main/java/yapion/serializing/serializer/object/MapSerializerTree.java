...
public class MapSerializerTree implements InternalSerializer<TreeMap<?, ?>> {
    ...
    @Override
    public YAPIONAnyType serialize(TreeMap<?, ?> object, YAPIONSerializer yapionSerializer) {
    ...
    @Override
    public TreeMap<?, ?> deserialize(YAPIONAnyType yapionAnyType, YAPIONDeserializer yapionDeserializer) {
