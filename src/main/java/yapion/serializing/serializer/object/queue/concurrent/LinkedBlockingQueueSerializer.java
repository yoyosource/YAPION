...
public class LinkedBlockingQueueSerializer implements InternalSerializer<LinkedBlockingQueue<?>> {
    ...
    @Override
    public YAPIONAnyType serialize(SerializeData<LinkedBlockingQueue<?>> serializeData) {
    ...
    @Override
    public LinkedBlockingQueue<?> deserialize(DeserializeData<? extends YAPIONAnyType> deserializeData) {
