...
public class BlockingQueueSerializer implements InternalSerializer<BlockingQueue<?>> {
    ...
    @Override
    public BlockingQueue<?> deserialize(DeserializeData<? extends YAPIONAnyType> deserializeData) {
