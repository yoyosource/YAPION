...
public class ConcurrentNavigableMapSerializer implements InternalSerializer<ConcurrentNavigableMap<?, ?>> {
    ...
    @Override
    public YAPIONAnyType serialize(SerializeData<ConcurrentNavigableMap<?, ?>> serializeData) {
    ...
    @Override
    public ConcurrentNavigableMap<?, ?> deserialize(DeserializeData<? extends YAPIONAnyType> deserializeData) {
