...
public class SetSerializerHash implements InternalSerializer<HashSet<?>> {
    ...
    @Override
    public YAPIONAnyType serialize(HashSet<?> object, YAPIONSerializer yapionSerializer) {
    ...
    @Override
    public HashSet<?> deserialize(YAPIONAnyType yapionAnyType, YAPIONDeserializer yapionDeserializer) {
