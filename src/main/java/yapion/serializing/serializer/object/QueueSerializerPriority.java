...
public class QueueSerializerPriority implements InternalSerializer<PriorityQueue<?>> {
    ...
    @Override
    public YAPIONAnyType serialize(PriorityQueue<?> object, YAPIONSerializer yapionSerializer) {
    ...
    @Override
    public PriorityQueue<?> deserialize(YAPIONAnyType yapionAnyType, YAPIONDeserializer yapionDeserializer) {
