...
public class DequeSerializerArray implements InternalSerializer<ArrayDeque<?>> {
    ...
    @Override
    public YAPIONAnyType serialize(ArrayDeque<?> object, YAPIONSerializer yapionSerializer) {
    ...
    @Override
    public ArrayDeque<?> deserialize(YAPIONAnyType yapionAnyType, YAPIONDeserializer yapionDeserializer) {
