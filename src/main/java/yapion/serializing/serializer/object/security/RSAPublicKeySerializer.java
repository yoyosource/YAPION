...
public class RSAPublicKeySerializer implements InternalSerializer<RSAPublicKeyImpl> {

    @Override
    public String type() {
        return "sun.security.rsa.RSAPublicKeyImpl";
    }

    @Override
    public YAPIONAnyType serialize(SerializeData<RSAPublicKeyImpl> serializeData) {
    ...
    @Override
    public RSAPublicKeyImpl deserialize(DeserializeData<? extends YAPIONAnyType> deserializeData) {
        ...
        try {
            return (RSAPublicKeyImpl) RSAPublicKeyImpl.newKey(encoded);
