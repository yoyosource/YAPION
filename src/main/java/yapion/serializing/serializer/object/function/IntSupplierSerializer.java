...
public class IntSupplierSerializer extends AbstractFunctionSerializer<IntSupplier> implements FinalInternalSerializer<IntSupplier> {

    @Override
    public void init() {
        clazz = IntSupplier.class;
    }
}
