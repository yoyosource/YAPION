...
public class IntPredicateSerializer extends AbstractFunctionSerializer<IntPredicate> implements FinalInternalSerializer<IntPredicate> {

    @Override
    public void init() {
        clazz = IntPredicate.class;
    }
}
