...
public class UnaryOperatorSerializer extends AbstractFunctionSerializer<UnaryOperator> implements FinalInternalSerializer<UnaryOperator> {

    @Override
    public void init() {
        clazz = UnaryOperator.class;
    }
}
