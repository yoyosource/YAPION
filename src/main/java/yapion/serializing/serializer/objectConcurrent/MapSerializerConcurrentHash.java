...
public class MapSerializerConcurrentHash implements InternalSerializer<ConcurrentHashMap<?, ?>> {
    ...
    @Override
    public YAPIONAnyType serialize(ConcurrentHashMap<?, ?> object, YAPIONSerializer yapionSerializer) {
    ...
    @Override
    public ConcurrentHashMap<?, ?> deserialize(YAPIONAnyType yapionAnyType, YAPIONDeserializer yapionDeserializer) {
