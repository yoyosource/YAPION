[![YAPION Version V0.20.2](https://img.shields.io/badge/YAPION%20Version-0.20.2-red)](https://github.com/yoyosource/YAPION/tree/master/)
...
dependencies {
    implementation 'yoyosource:YAPION:0.20.2'
}
```
