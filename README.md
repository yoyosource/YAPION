[![YAPION Version V0.21.1](https://img.shields.io/badge/YAPION%20Version-0.21.1-red)](https://github.com/yoyosource/YAPION/tree/master/)
...
dependencies {
    implementation 'yoyosource:YAPION:0.21.1'
}
```
