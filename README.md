[![YAPION Version V0.14.1](https://img.shields.io/badge/YAPION%20Version-0.14.1-red)](https://github.com/yoyosource/YAPIOn/tree/master/)
...
dependencies {
    implementation 'yoyosource:YAPION:0.14.1'
}
```
