[![YAPION Version V0.19.0](https://img.shields.io/badge/YAPION%20Version-0.19.0-red)](https://github.com/yoyosource/YAPION/tree/master/)
...
dependencies {
    implementation 'yoyosource:YAPION:0.19.0'
}
```
