[![YAPION Version V0.3.0](https://img.shields.io/badge/YAPION%20Version-0.3.0-red)](https://github.com/yoyosource/YAPIOn/tree/master/)
...
dependencies {
    implementation 'yoyosource:YAPION:0.3.0'
}
```
