[![YAPION Version V0.6.0](https://img.shields.io/badge/YAPION%20Version-0.6.0-red)](https://github.com/yoyosource/YAPIOn/tree/master/)
...
dependencies {
    implementation 'yoyosource:YAPION:0.6.0'
}
```
